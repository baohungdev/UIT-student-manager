    ...
    <div class="main">
        <div class="login">
            <form action="" method="post" name="login">
                <fieldset>
                    <legend class="heading">Nhập liệu</legend>
        ...
        <div class="search">
            <form action="./student.php" method="get">
                <fieldset>
                    <legend class="heading">Xem Kết quả</legend>
                    ...
                    <input type="text" name="rn" placeholder="Số thứ tự">
                    <input type="submit" value="Lấy kết quả">
                </fieldset>
            </form>
        </div>
    </div>
