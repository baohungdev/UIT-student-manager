...
<body>
    ...
    <div class="container">
        <div class="details">
            <span>Tên:</span> <?php echo $name ?> <br>
            <span>Lớp:</span> <?php echo $class; ?> <br>
            <span>Số thứ tự:</span> <?php echo $rn; ?> <br>
        </div>
        ...
        <div class="result">
            <?php echo '<p>Tổng điểm:&nbsp'.$mark.'</p>';?>
            <?php echo '<p>Điểm trung bình:&nbsp'.$percentage.'</p>';?>
        </div>
